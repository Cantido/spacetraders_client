defmodule SpacetradersClientWeb.CoreComponents do
  @moduledoc """
  ...
  def icon(%{name: "game-" <> name} = assigns) do
    ...
    <img
      class={@class}
      src={"/images/game-icons/icons/#{@hex}/transparent/1x1/#{@game_icon}.svg"}
      width={@size}
      height={@size}
    />
    """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SpacetradersClientWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SpacetradersClientWeb.Gettext, "errors", msg, opts)
    end
  end
